...
const translations: Record<Lang, Record<string, string>> = {
  en: {
    ...
    opening_hymn_number: 'Opening Hymn Number',
    sacrament_hymn_number: 'Sacrament Hymn Number',
    closing_hymn_number: 'Closing Hymn Number',
    ...
    add_musical_number: 'Add Musical Number',
    add_testimonies: 'Add Testimonies',
    add_sacrament: 'Add Sacrament',
  ...
  es: {
    ...
    ward_name: 'Nombre del Barrio',
    date: 'Fecha',
    theme_scripture: 'Tema/Escritura',
    opening_hymn_number: 'Número del Himno de Apertura',
    sacrament_hymn_number: 'Número del Himno de la Santa Cena',
    closing_hymn_number: 'Número del Himno de Clausura',
    ...
    intermediate_hymn: 'Himno Intermedio',
    ...
    add_speaker: 'Agregar Orador',
    add_musical_number: 'Agregar Número Musical',
    add_testimonies: 'Agregar Testimonios',
    add_sacrament: 'Agregar Santa Cena',
